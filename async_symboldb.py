...
class SymbolDB:
    ...
    async def batch_update(
        ...
        # return await self._post('batch', data=data, headers=headers)
    ...
    async def update_schedule(self, data: dict, _id = None) -> dict:
        """
        updates schedule
        :param data: data to be posted
    ...
    async def create_schedule(self, data) -> dict:
        ...
        return await self._post(f'schedules', jdata=data)
    ...
    async def get_schedule(self, uuid: str = None, **kwargs) -> list[dict]:
        """
        returns schedule
    ...
    async def post_currency(self, data, _id=str()) -> dict:
        """
    ...
    async def post_currencies_holidays(self, currency, date, isHoliday=True):
        """
